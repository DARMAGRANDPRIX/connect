...
public class HouseController {
     ...
     public String show(@PathVariable(name = "houseId") Integer houseId, Model model, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl) {
         ...
         boolean userHasReviewes = !reviewRepository.findByHouseIdAndUserId(houseId, user.getId()).isEmpty();
         boolean houseHasReviews = !reviewRepository.findTop6ByHouseIdOrderByCreatedAtDesc(houseId).isEmpty();
         ...
         System.out.println("User ID: " + userDetailsImpl.getUser().getId());
